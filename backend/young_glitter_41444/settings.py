"""
Django settings for young_glitter_41444 project.
...
ROOT_URLCONF = 'young_glitter_41444.urls'
...
WSGI_APPLICATION = 'young_glitter_41444.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "young_glitter_41444 API",
    "DESCRIPTION": "API documentation for young_glitter_41444 App",
    "VERSION": "v1",
}
